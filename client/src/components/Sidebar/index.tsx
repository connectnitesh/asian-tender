...
const Sidebar = ({ sidebarOpen, setSidebarOpen, handleComponentChange, logout }: SidebarProps) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-2 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg shadow-lg mx-2">
        <h2 className="text-2xl font-bold text-white">Admin Asian Tender</h2>
      </div>
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${(pathname === "/" || pathname.includes("dashboard")) &&
                          "bg-graydark dark:bg-meta-4"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                          handleComponentChange("dashboard"); // Pass the component identifier here
                        }}
                      >
                        <svg
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              onClick={(e) => {
                                e.preventDefault();
                                handleComponentChange("create-tender"); // Pass the component identifier here
                              }}
                            >
                              Home
                            </Link>

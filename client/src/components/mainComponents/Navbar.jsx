...
const Navbar = () => {
  ...
  <ul className="flex justify-center space-x-4">
    <li className="pt-1">
      <a href="/tenders" className="hover:underline decoration-gray-400 underline-offset-4">Tenders</a>
    </li>
    <li className="pt-1">
      <a href="/subscribe" className="hover:underline decoration-gray-400 underline-offset-4">Subscription Plan</a>
    </li>
    <li className="pt-1">
      <a href="/about" className="hover:underline decoration-gray-400 underline-offset-4">About Us</a>
    </li>
    <li className="pt-1">
      <a href="/contact" className="hover:underline decoration-gray-400 underline-offset-4">Contact Us</a>
    </li>
  </ul>
</div>
